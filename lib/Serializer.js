 ...
 * as buffer
 */
Serializer.from_json = function (obj, token) {
    // Create a copy of the object so we don't modify the original one
    var obj = extend(true, {}, obj);
    var so = new Serializer(null, token);
    var typedef;
 ...
 */
Serializer.prototype.hash = function (prefix, token) {
    var sign_buffer = new Serializer(null, token);
    // Add hashing prefix
