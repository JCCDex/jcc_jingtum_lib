...
Serializer.prototype.init = function (base_wallet_currency) {
...
Serializer.prototype.to_json = function () {
    ...
    while (this.pointer < this.buffer.length) {
        ...
        var key_and_value = stypes.parse(this, this._base_wallet_currency); //xdjiang-2018-09-04
...
Serializer.prototype.hash = function (prefix) {
    ...
    if ("undefined" !== typeof prefix) {
        stypes.Int32.init(this._base_wallet_currency); //xdjiang-2018-09-04
