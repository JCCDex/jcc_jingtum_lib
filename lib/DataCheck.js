...
function isCurrency(code) {
    return typeof code === 'string' && (!!code && code.length >= CURRENCY_NAME_LEN && code.length <= CURRENCY_NAME_LEN2);
}
...
function isTumCode(code) {
    ...
    return typeof code === 'string' && (code === 'SWT' || isCurrency(code) || isCustomTum(code));
}
