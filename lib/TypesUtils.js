...
var arraySet = require('../src/utils').arraySet;
...
function parse(so) {
  ...
  var field_name = field_bits === 0 ? FIELDS_MAP[type_bits][so.read(1)[0]] : FIELDS_MAP[type_bits][field_bits];
  ...
  var type = field_name === 'Memo' ? exports.STMemo : exports[TYPES_MAP[type_bits]];
